...
struct EventEditView: View {
    ...
    private func saveChanges() {
        ...
        Task {
            do {
                if var feed = event as? FeedEvent {
                    feed.timestamp = timestamp
                    feed.notes = notes.isEmpty ? nil : notes
                    feed.updatedAt = Date()
                ...
                } else if var sleep = event as? SleepEvent {
                    sleep.timestamp = timestamp
                    sleep.notes = notes.isEmpty ? nil : notes
